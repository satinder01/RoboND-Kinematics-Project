...
test_cases = {1:[[[2.16135,-1.42635,1.55109],
              ...
              4:[[[-0.172, -2.925, 2.125],
                  [0.919, -0.338, 0.181, -0.090]],
                  [-0.386, -2.727, 2.043],
                  [-1.71, 0.94, -1.36, -1.54, -0.91, -0.95]],
              5:[]}
...
############ Read from other file - Start
    ...
    FK = T0_G.evalf(subs={q1:theta1, q2:theta2, q3:theta3, q4:theta4, q5:theta5, q6:theta5})
